    ...
    return (
        <header className={`sidebar fixed top-0 left-0 bg-quintenary shadow font-inter ${isOpen ? 'open' : ''}`}>
            ...
            <ul className="nav-list px-3.5">
                <li>
                    <Link to={'/painelAdmin'} className="link">
                ...
                <li>
                    <Link to={'/painelAdminSolicitacao'} className="link">
                        <div className='iconSideBar flex justify-center items-center'>
                            <FaCalendarAlt className='text-2xl' />
                        </div>
                        <span className="links-name">Solicitações</span>
                    </Link>
                    <span className="tooltip">Solicitações</span>
                </li>
                
                <li>
                    <Link to={'/historicoAgendamentoAdm'} className="link">
                        <div className='iconSideBar flex justify-center items-center'>
                            <FaHistory className='text-2xl' />
                        </div>
                        <span className="links-name">Histórico</span>
                    </Link>
                    <span className="tooltip">Histórico</span>
                </li>
                
                <li>
                    <Link to={'/configuracoesAdmin'} className="link">
                        <div className='iconSideBar flex justify-center items-center'>
