            ...
            <section className='w-full lg:w-[50%] h-screen flex flex-col items-baseline'>
                ...
                <section className='shadow-custom-sm w-[65%] m-auto px-10 py-5 rounded-lg'>
                    ...
                    <form className='w-full flex flex-col justify-center items-center gap-5 mb-5'>
                        ...
                        <button className='bg-tertiary hover:bg-tertiary-500 transition ease-in-out text-white-custom font-semibold w-[80%] py-0.5 mt-2 rounded-sm cursor-pointer shadow-sm'>
                            Entrar
                        </button>
                    </form>
