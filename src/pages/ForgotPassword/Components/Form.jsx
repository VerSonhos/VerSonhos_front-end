    ...
    return (
        <>
            <section className='w-full min-h-screen flex flex-col items-baseline bg-gradient-to-t from-quintenary to-tertiary'>
                ...
                <Link
                    to={'/login'}
                    className='flex justify-center items-center gap-2 font-inter font-bold text-lg mt-5 ms-5 text-white-custom text-shadow'
                >
                ...
                <section className='shadow-custom-sm w-[90%] lg:w-[40%] m-auto px-10 py-15 rounded-lg bg-white-custom'>
                    <img
                        src={LogoForm}
                        alt="Logotipo VerSonhos"
                        className='w-[75%] md:w-[65%] mx-auto mb-7'
                    />
                    ...
                    >
                        <div className='w-full flex flex-col items-start justify-center gap-2'>
                            <label
                                htmlFor="emailForgot"
                                className='text-black-custom-500 font-semibold'
                            >
                                E-mail:
                            </label>
                            ...
                            <div className='w-full flex relative'>
                                ...
                                <input
                                    ...
                                    required
                                    className='bg-gray-100 border-gray-300 border-2 focus:border-tertiary outline-0 focus:shadow-tertiary transition ease-in-out rounded-md w-full py-1.5 ps-9 pe-4'
                                />
                            </div>
                        </div>
                        ...
                        <button
                            type='submit'
                            disabled={loading}
                            className='bg-tertiary hover:bg-tertiary-500 transition ease-in-out text-white-custom font-semibold w-[70%] py-1 mt-2 rounded-sm cursor-pointer shadow-sm disabled:opacity-60'
                        >
                    ...
                    <div className='text-center flex flex-col gap-5 text-black-custom-500'>
                        <p>
                            ...
                            <Link
                                to={'/login'}
                                className='text-center text-tertiary hover:text-tertiary-400 transition ease-in-out italic'
                            >
                                Voltar
                            </Link>
                        </p>
