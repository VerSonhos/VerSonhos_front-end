...
import { loginAdmin} from '@/services/authServiceAdmin';
    ...
    return (
        <>
            ...
            <section className='w-full lg:w-[50%] min-h-screen flex flex-col items-baseline'>
                ...
                <section className='shadow-custom-sm md:w-[65%] m-auto px-10 py-5 my-10 rounded-lg'>
                    ...
                    <form className='w-full flex flex-col justify-center items-center gap-5 mb-5'>
                        <div className='w-full flex flex-col items-start justify-center gap-2'>
                            ...
                            <div className='w-full flex relative'>
                                ...
                                <input type="email" placeholder='seu@email.com' name="emailLoginAdmin" id="emailLoginAdmin" value={loginValue} onChange={(e) => setLoginValue(e.target.value)} className='bg-gray-100 border-gray-300 border-2 focus:border-tertiary outline-0 focus:shadow-tertiary transition ease-in-out rounded-md w-full py-1.5 ps-9 pe-4' />
                            </div>
                        </div>
                        ...
                        <div className='w-full flex flex-col items-start justify-center gap-2'>
                            ...
                            <div className="w-full flex relative">
                                ...
                                <input type={showPassword ? "text" : "password"} placeholder='*********' name="passwordLoginAdmin" id="passwordLoginAdmin" value={senha} onChange={(e) => setSenha(e.target.value)} className='bg-gray-100 border-gray-300 border-2 focus:border-tertiary outline-0 focus:shadow-tertiary transition ease-in-out rounded-md w-full py-1.5 ps-9 pe-4' />
