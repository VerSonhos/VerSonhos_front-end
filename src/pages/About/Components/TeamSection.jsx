...
export default function TeamSection() {
  ...
  return (
    <section className="flex flex-col justify-center items-center p-8 md:p-16 pb-32">
      <h3 className="text-4xl md:text-5xl font-bold mb-8 font-fredoka text-thirteenth" >Conheça nosso <span className='text-tertiary'>time</span></h3>
          ...
          >
            ...
            >
              ...
              <div className='flex gap-2 mt-2'>
                {m.linkedin && (
                  <a href={m.linkedin} target="_blank" rel="noopener noreferrer" aria-label={`LinkedIn de ${m.name}`} className="hover:opacity-80">
                    <LinkedInIcon />
                  </a>
                )}
                {m.github && (
                  <a href={m.github} target="_blank" rel="noopener noreferrer" aria-label={`GitHub de ${m.name}`} className="hover:opacity-80">
                    <GithubIcon />
                  </a>
                )}
              </div>
