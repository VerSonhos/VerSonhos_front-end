                    ...
                    <section id='secondStep' className='flex w-full flex-col justify-center items-center gap-5'>
                        ...
                        <div className='w-full flex flex-col items-start justify-center gap-2'>
                            ...
                            <div className='w-full flex relative'>
                                ...
                                <input type="text" onChange={handleChange} value={formData.cpf} placeholder='999.999.999-9' name="cpf" id="cpf" className={`bg-gray-100 border-2 ${errors['cpf'] ? 'border-red-500' : 'border-gray-300 focus:border-tertiary'} outline-0 focus:shadow-tertiary transition ease-in-out rounded-md w-full py-1.5 ps-9 pe-4`} />
                            </div>
